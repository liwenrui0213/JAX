...
for i in range(len(cifar10_dataset)):
    train_images.append(cifar10_dataset[i][0])
    train_labels.append(one_hot(cifar10_dataset[i][1], n_targets))
    test_images.append(cifar10_testset[i][0])
    test_labels.append(one_hot(cifar10_testset[i][1], n_targets))
